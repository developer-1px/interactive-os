...
// turbo-all
1. Ensure the development server is active. If not, start it in the background using `npm run dev`.
2. Open a browser subagent and navigate to the application URL (e.g. `http://localhost:5173` or `http://localhost:5174`).
3. **Audit Runtime Errors**: 
