...
- W3. `6-project/` 구조가 이 분류를 물리적으로 증명.
...
```
6-project/BuilderIcon.tsx  → CURSOR_META = { tag: "icon", color: "#f59e0b" }
6-project/BuilderButton.tsx → CURSOR_META = { tag: "button", color: "#3b82f6" }
...
