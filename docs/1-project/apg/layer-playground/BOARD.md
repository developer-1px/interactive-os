...
## Unresolved
(all items delegated to OS gap backlog — not actionable in this project)
- ~~tooltip hover trigger headless 지원 여부~~ → OG-022
- ~~popover non-modal Tab 동작 정확성~~ → OG-016 (headless Tab trap)
- ~~alertdialog Escape 차단 동작~~ → OG-023
