...
## 🎯 Now (진행 중인 태스크)
- [ ] T6: Inspector scope 기본 제외 필터 — selectFilteredTransactions에서 inspector scope 트랜잭션 기본 제외
- [ ] T7: [data-inspector] 가드 전면 제거 — senseMouse, senseClickTarget, resolveKeyboard, FocusListener, PointerListener 5곳
- [ ] T8: data-inspector DOM 속성 제거 + ZiftMonitor onClick 우회 제거
- [ ] T9: SPEC.md 규칙 갱신 + regression 검증
