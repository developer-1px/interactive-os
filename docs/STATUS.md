...
testing/testbot-discovery — TestBot 자동 발견 + route 기반 패널 필터링
...
| Project | Phase | Last Activity |
|---------|-------|---------------|
| 🔥 **testbot-discovery** | Scaffold | 03-10 |
| **headless-page**/headless-simulator ⚠️ | Phase 7 Done, Phase 1-6 미착수 | 03-09 |
...
| Active Focus | 1 (testbot-discovery) |
| Stale (4d+) | 5 |
| Active Migrations | 0 |
| Inbox | docs/0-inbox/ |
