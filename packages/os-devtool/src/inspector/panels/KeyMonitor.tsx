import type { LoggedKey } from "@inspector/panels/LoggedKey.ts";
    ...
    <div className="flex gap-1.5 overflow-x-auto p-3 min-h-[44px] bg-[#ffffff] custom-scrollbar">
      {rawKeys.map((log, i) => (
        <div
          ...
          className={`flex flex-col items-center justify-center min-w-[32px] h-8 border transition-all duration-200 ${
            i === 0
