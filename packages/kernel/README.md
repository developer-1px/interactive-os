...
📖 **[Full Documentation →](../../docs/2-area/kernel/00-overview.md)**

| Guide | Description |
|---|---|
| [Overview](../../docs/2-area/kernel/00-overview.md) | Architecture and design philosophy |
| [Getting Started](../../docs/2-area/kernel/01-getting-started.md) | First kernel in under a minute |
| [Core Concepts](../../docs/2-area/kernel/02-core-concepts.md) | Commands, Effects, Context, Scope |
| [API Reference](../../docs/2-area/kernel/03-api-reference.md) | Complete API documentation |
| [Type System](../../docs/2-area/kernel/05-type-system.md) | Branded tokens and compile-time safety |
| [Patterns](../../docs/2-area/kernel/08-patterns.md) | Best practices |
