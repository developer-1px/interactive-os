...
import type { NavigateConfig } from "../../schema/types/focus/config/FocusNavigateConfig.ts";
import type { Direction } from "../../schema/types/focus/FocusDirection.ts";
...
// "linear-both": all 4 arrows use linear nav (radiogroup)
// "both": all 4 arrows use spatial nav (grid)
registerNavigationStrategy("linear-both", resolveLinear, {
  needsDOMRects: false,
});
