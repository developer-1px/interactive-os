            ...
            <header className="mb-12 border-b border-white/5 pb-8">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <MockText variant="caption" className="mt-1">Interface OS Mock Component System</MockText>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/5 bg-white/[0.02] space-y-8">
                        <div>
                            <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Typography</h4>
                            <div className="space-y-2">
                                <MockText variant="h1">Heading 1</MockText>
                                <MockText variant="h2">Heading 2</MockText>
                                <MockText variant="body">Body text example with standard weights.</MockText>
                                <MockText variant="caption">Caption text for smaller details.</MockText>
                            </div>
                        </div>
                        ...
                        <div>
                            <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Badges</h4>
                        ...
                        <div>
                            <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Shortcuts</h4>
                            <div className="space-y-2">
                                <MockShortcut keys={['⌘', 'K']} />
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/5 bg-white/[0.02] space-y-8">
                        <div>
                            <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Inputs</h4>
                            <div className="space-y-4">
                                <MockInput placeholder="Standard Input..." />
                                <MockInput label="With Label" placeholder="Enter value..." />
                                <MockInput label="Error State" error placeholder="Invalid input" defaultValue="Wrong Value" />
                                <MockToggle label="Toggle Option" checked={toggle} onChange={setToggle} />
                            </div>
                        </div>
                        ...
                        <div>
                            <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Buttons</h4>
                            <div className="flex flex-wrap gap-3">
                                <MockButton onClick={triggerLoad} loading={loading}>Primary Action</MockButton>
                                <MockButton intent="secondary" icon={<Layout size={14} />}>Secondary</MockButton>
                                <MockButton intent="danger" icon={<Bell size={14} />}>Danger</MockButton>
                                    ...
                                    <MockScrollArea>
                                        <div className="space-y-4">
                                            {Array.from({ length: 10 }).map((_, i) => (
                                                <div key={i} className="h-12 rounded bg-white/5 w-full animate-pulse" style={{ animationDelay: `${i * 100}ms` }} />
                                            ))}
                                        </div>
                                    </MockScrollArea>
                                </div>
