import { Eye, Smartphone, Monitor, MousePointer2, Hand, Square, Undo2, Redo2 } from "lucide-react";
    ...
    return (
        <div className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl border-b border-slate-200 shadow-sm">
            <div className="flex items-center justify-between px-4 py-2">
                ...
                <div className="flex items-center gap-1 bg-slate-100 rounded-lg p-1">
                    <DeviceButton icon={<Monitor size={15} />} active label="Desktop" />
                    <DeviceButton icon={<Smartphone size={15} />} label="Mobile" />
                </div>
...
function DeviceButton({ icon, active, label }: { icon: React.ReactNode; active?: boolean; label: string }) {
    return (
        <button
            className={`
