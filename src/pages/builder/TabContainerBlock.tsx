                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {tabs.length > 0 ? (
                        ...
                        <div className="py-20 text-center text-slate-400 border-2 border-dashed border-slate-300 rounded-2xl bg-white/50 backdrop-blur-sm shadow-sm">
                            <p className="text-base font-semibold text-slate-600">No tabs yet</p>
                            <p className="text-sm mt-2 text-slate-500">Add tab blocks here to create tabs</p>
                        </div>
                    )}
                </div>
            </div>
        ...
        return (
            <div className="py-16 mt-8 text-center border border-slate-100 bg-white rounded-2xl">
                <p className="text-base text-slate-500">
                    Empty tab — <span className="font-semibold text-slate-700">"{tab.label}"</span>
                </p>
                <p className="text-sm mt-2 text-slate-400">Paste sections here to add content</p>
            </div>
        );
    }
                        ...
                        {Object.entries(section.fields)
                            ...
                            .map(([key, value]) => (
                                <div key={key} className="mt-4 pt-4 border-t border-slate-100">
                                    <span className="text-xs text-indigo-500 font-bold uppercase tracking-widest">{key}</span>
