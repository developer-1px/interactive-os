            ...
            {filteredPages.length === 0 ? (
              ...
              filteredPages.map((page) => (
                <Item key={page.id} id={page.id} asChild>
                  <button className="w-full grid grid-cols-12 gap-4 px-6 py-4 items-center text-left border-b border-slate-100 last:border-0 hover:bg-slate-50 focus:bg-blue-50 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-blue-500 transition-colors group data-[focused]:bg-blue-50 data-[focused]:ring-1 data-[focused]:ring-blue-500">
