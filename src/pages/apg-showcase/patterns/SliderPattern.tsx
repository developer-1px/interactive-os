...
import { OS_VALUE_CHANGE } from "@os/4-command";
...
function SliderTrack({
  ...
  return (
    <div className="relative h-3 rounded-full overflow-hidden bg-gray-200 flex-1">
      ...
      <div
        className={clsx(
          "absolute inset-y-0 left-0 bg-gradient-to-r rounded-full transition-all duration-75",
          gradient,
        )}
        style={{ width: `${percent}%` }}
      />
  ...
  return (
    <div className="max-w-md">
      ...
      <p className="text-sm text-gray-500 mb-4">
        W3C APG Slider Pattern: RGB color picker. <kbd>↑↓←→</kbd> adjust value
        by 1. <kbd>PgUp/PgDn</kbd> adjust by 10. <kbd>Home/End</kbd> jump to
        min/max.{" "}
        <a
