...
export const SHOW_ALERT = AlertApp.command("SHOW_ALERT", (ctx) => ({
    state: {
        alerts: [...ctx.state.alerts, { id: `alert-${Date.now()}-${Math.random()}` }],
    },
}));
    ...
    return (
        <div className="max-w-lg">
            ...
            <p className="text-sm text-gray-500 mb-4">
                ...
                appear below. The alert is announced by screen readers without moving focus.
            </p>
            ...
            <div className="flex flex-col gap-2">
                {alerts.map((alert) => (
                    ...
                    >
                        <p className="text-sm">
                            <strong>Hello!</strong> This is an inline alert message.
                            It is triggered by an event and announced immediately.
                        </p>
                    </div>
                ))}
            </div>
