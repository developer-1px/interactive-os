...
function TreeContent() {
    ...
    return (
        <>
          ...
          "
            >
                <Icon name={isExpanded("node-1") ? "chevron-down" : "chevron-right"} size={14} className="text-gray-400" />
          ...
          "
            >
                <Icon name={isExpanded("node-2") ? "chevron-down" : "chevron-right"} size={14} className="text-gray-400" />
                <Icon name="folder" size={16} className="text-amber-500" />
                <span>Pictures</span>
            </FocusItem>
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            ...
            <p className="text-sm text-gray-500 mb-4">
                Supports: <kbd>Arrow</kbd> navigation, <kbd>Left</kbd>/<kbd>Right</kbd> to expand/collapse, <kbd>Space</kbd> to select, <kbd>Shift+Click</kbd> or <kbd>Shift+Arrow</kbd> for range selection.
            </p>
