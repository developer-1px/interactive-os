...
export function AutofocusTest() {
  ...
  const runTest = async () => {
    ...
    try {
      ...
      await wait(200);
      const hasFocus =
        document.querySelector("#af-auto-1")?.getAttribute("aria-current") ===
        "true";
          ...
          >
            {["Auto 1", "Auto 2"].map((item) => (
              <FocusItem
                ...
                role="option"
                className="px-3 py-1.5 rounded hover:bg-gray-100 aria-[current=true]:bg-fuchsia-100 aria-[current=true]:text-fuchsia-700 text-sm transition-all border border-transparent aria-[current=true]:border-fuchsia-300"
              >
                {item}
              </FocusItem>
            ))}
          ...
          >
            {["Top", "Middle", "Bottom"].map((item) => (
              <FocusItem
                ...
                role="option"
                className="px-3 py-1.5 rounded hover:bg-gray-100 aria-[current=true]:bg-orange-100 aria-[current=true]:text-orange-700 text-sm transition-all border border-transparent aria-[current=true]:border-orange-300"
              >
                {item}
              </FocusItem>
            ))}
