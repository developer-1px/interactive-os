...
const typeaheadJumpScript: TestScript = {
  ...
  async run(page, expect) {
    ...
    await expect(page.locator("#ta-apple")).toHaveAttribute(
      "aria-current",
      "true",
    );

    await page.keyboard.press("c");
    await expect(page.locator("#ta-cherry")).toHaveAttribute(
      "aria-current",
      "true",
    );
  },
...
const typeaheadWrapScript: TestScript = {
  ...
  async run(page, expect) {
    ...
    await expect(page.locator("#ta-date")).toHaveAttribute(
      "aria-current",
      "true",
    );

    await page.keyboard.press("b");
    await expect(page.locator("#ta-banana")).toHaveAttribute(
      "aria-current",
      "true",
    );
  },
...
const disabledSkipScript: TestScript = {
  ...
  async run(page, expect) {
    ...
    await expect(page.locator("#dis-1")).toHaveAttribute(
      "aria-current",
      "true",
    );
    ...
    await page.keyboard.press("ArrowDown");
    await expect(page.locator("#dis-4")).toHaveAttribute(
      "aria-current",
      "true",
    );
    ...
    await page.keyboard.press("ArrowDown");
    await expect(page.locator("#dis-5")).toHaveAttribute(
      "aria-current",
      "true",
    );
  },
...
const tablistNavigateScript: TestScript = {
  ...
  async run(page, expect) {
    ...
    await expect(page.locator("#tl-tab-1")).toHaveAttribute(
      "aria-selected",
      "true",
    );

    await page.keyboard.press("ArrowRight");
    await expect(page.locator("#tl-tab-2")).toHaveAttribute(
      "aria-current",
      "true",
    );
    await expect(page.locator("#tl-tab-2")).toHaveAttribute(
    ...
    await page.keyboard.press("ArrowRight");
    await expect(page.locator("#tl-tab-3")).toHaveAttribute(
      "aria-selected",
      "true",
    );
  },
...
const radiogroupCheckedScript: TestScript = {
  ...
  async run(page, expect) {
    ...
    await expect(page.locator("#rg-small")).toHaveAttribute(
      "aria-checked",
      "true",
    );

    await page.keyboard.press("ArrowDown");
    await expect(page.locator("#rg-medium")).toHaveAttribute(
      "aria-checked",
      "true",
    );
    await expect(page.locator("#rg-small")).toHaveAttribute(
