...
export const mapStateToContext = (state: AppState, focusedItemId: string | null, activeZoneId: string | null): TodoContext & Record<string, any> => {
    const { ui, data } = state;
    ...
    return {
        ...
        isLastColumn: data.categoryOrder.indexOf(ui.selectedCategoryId) === data.categoryOrder.length - 1,
