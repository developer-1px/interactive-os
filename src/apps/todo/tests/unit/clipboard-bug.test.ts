...
import { TodoApp, INITIAL_STATE } from "../../app"; // This registers TodoApp commands
...
describe("TodoApp Clipboard Multi-Select Bug", () => {
    ...
    function getTodoOrder() {
        return (kernel.getState().apps["todo-v5"] as typeof INITIAL_STATE).data.todoOrder;
    }

    function getClipboard() {
        return (kernel.getState().apps["todo-v5"] as typeof INITIAL_STATE).ui.clipboard;
    }
