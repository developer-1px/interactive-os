...
import { addTodo, TodoList, TodoApp } from "../../app";
import { createIntegrationTest } from "@/os/tests/createIntegrationTest";


describe("Todo Integration: Paste & Focus (OS Level)", () => {
    let testContext: ReturnType<typeof createIntegrationTest<import("../../model/appState").AppState>>;
    ...
    it("should select and focus newly pasted items", async () => {
        ...
        const [id1, id2] = testContext.state.data.todoOrder.slice(-2);
