/**
 * TaskItemV3 — defineApp/createWidget version.
 *
...
import { TodoList, TodoEdit } from "@apps/todo/v3/app";
...
export function TaskItemV3({ todo, isEditing, editDraft }: TaskItemProps) {
            ...
            >
                ...
                >
                    {isEditing ? (
                        ...
                        <>
                            <OS.Trigger onPress={TodoList.commands.startEdit({ id: todo.id })}>
                            ...
                            <OS.Trigger onPress={TodoList.commands.moveItemUp({ focusId: todo.id })}>
                            ...
                            <OS.Trigger onPress={TodoList.commands.moveItemDown({ focusId: todo.id })}>
