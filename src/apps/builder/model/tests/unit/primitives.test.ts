...
import { encode, decode } from "../../primitives";
import type { PrimitiveType } from "../../primitives";
import { getPropertyDef, getBlockSchema } from "../../blockSchemas";
...
describe("Primitives: encode/decode round-trip", () => {
    ...
    it("button: full compound", () => {
        const value = { type: "button" as const, text: "Sign Up", href: "/signup", action: "link" as const };
    ...
    it("link: full compound", () => {
        const value = { type: "link" as const, text: "Learn More", href: "https://example.com", target: "_blank" as const };
        const encoded = encode(value);
    ...
    it("image: full compound", () => {
        const value = { type: "image" as const, src: "/hero.png", alt: "Hero Image" };
        const encoded = encode(value);
