...
import { Loader2, Info, CheckCircle, AlertTriangle, AlertCircle, MousePointer2 } from 'lucide-react';
...
export const MockSpinner: React.FC<MockSpinnerProps> = ({ size = 20, className }) => {
    return (
        <Loader2
            size={size}
