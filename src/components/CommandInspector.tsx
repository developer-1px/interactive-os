...
import { KeyMonitor } from "./inspector/KeyMonitor";
import type { KeyLog } from "./inspector/KeyMonitor";
import { StateMonitor } from "./inspector/StateMonitor";
import { RegistryMonitor } from "./inspector/RegistryMonitor";
import { EventStream } from "./inspector/EventStream";
import { DataStateViewer } from "./inspector/DataStateViewer";

// --- Main Component ---

export function CommandInspector() {
  const { state, activeKeybindingMap, ctx, providerValue } = useTodoEngine();
