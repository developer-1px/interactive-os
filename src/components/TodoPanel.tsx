                  ...
                  return (
                    ...
                    >
                      <Trigger command={ToggleTodo({ id: todo.id })}>
                        <div
                          className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-all duration-300 cursor-pointer flex-shrink-0 ${
                            todo.completed
                      ...
                      <div className="flex-1 min-w-0">
                        {isEditing ? (
                          ...
                          <span
                            className={`block truncate text-lg transition-all duration-300 pointer-events-none ${
                              todo.completed
