...
interface Widget<_S, C extends Record<string, CommandFactory<any, any>>> {
    ...
    Item: React.FC<{ id: string | number; className?: string; children?: ReactNode; asChild?: boolean }>;
...
interface AppInstance<S, AllC extends Record<string, CommandFactory<any, any>>, Sel extends SelectorMap<S>> {
    readonly state: S;
...
>(
    ...
    function createWidget<C extends Record<string, CommandFactory<any, any>>>(
        ...
        const ZoneComponent: React.FC<{ id?: string; className?: string; children?: ReactNode }> = ({
            id,
            className,
            children,
        }) => {
        ...
        const ItemComponent: React.FC<{
            ...
            return React.createElement(OS.Item, { id: String(id), className, asChild } as any, children);
        };
    ...
    function createTrigger<P>(
        ...
        Trigger: React.FC<{ children: ReactNode; className?: string; asChild?: boolean }>;
        Portal: React.FC<{ children: ReactNode; title?: string; description?: string; className?: string; contentClassName?: string }>;
        Content: React.FC<{ children: ReactNode; title?: string; className?: string; zoneClassName?: string }>;
    ...
    function createTrigger(commandOrConfig: any): any {
        ...
        // Dialog.Trigger
        const TriggerComponent: React.FC<{ children: ReactNode; className?: string; asChild?: boolean }> = ({
            children,
            className,
            asChild,
        }) => {
        ...
        const DismissComponent: React.FC<{ children: ReactNode; className?: string }> = ({
            children,
            className,
        }) => {
            return React.createElement(
        ...
        const ConfirmComponent: React.FC<{ children: ReactNode; className?: string }> = ({
            children,
            className,
        }) => {
    ...
    return {
        ...
        create(overrides?: Partial<S>): AppInstance<S, typeof allCommands, Sel> {
            const testState = overrides ? { ...initialState, ...overrides } : initialState;
