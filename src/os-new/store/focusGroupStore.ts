 ...
 *
 * @deprecated Zustand per-zone store는 Kernel State로 전환 예정.
 * 새 코드에서는 `6-components/Zone.tsx` + Kernel `useComputed`를 사용하세요.
 * 참고: primitives/FocusGroup.tsx → 6-components/Zone.tsx
 */
