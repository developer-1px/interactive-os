...
// ═══════════════════════════════════════════════════════════════════
// §5 Write-first Agent Activity — session groups (Write-first UI)
// ═══════════════════════════════════════════════════════════════════

export const sessionGroupScripts: TestScript[] = [
  {
    name: "§5a docs-recent zone: 항목 클릭 → selectDoc 동작 보존",
    zone: "docs-recent",
    async run(page, expect) {
...
// §6 removed — commitMessage display superseded by Write-first UI
