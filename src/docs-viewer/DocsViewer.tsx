...
import type { DocItem } from "../pages/docs/DocsSidebar";
import { cleanLabel } from "../pages/docs/DocsSidebar";
import { MermaidBlock } from "../pages/docs/MermaidBlock";
import "../pages/docs/codeTheme.css";
import { DocsSidebarStandalone } from "./DocsSidebarStandalone";
...
export function DocsViewer() {
    ...
    useEffect(() => {
        ...
        const loadContent = async () => {
            try {
                const filePath = `../../docs/${activePath}.md`;
