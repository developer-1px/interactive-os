...
import { OS_ACTIVATE } from "@os/4-command/activate/activate";
import { OS_CHECK } from "@os/4-command/activate/check";
import { OS_COPY } from "@os/4-command/clipboard/clipboard";
import { OS_DELETE } from "@os/4-command/crud/delete";
