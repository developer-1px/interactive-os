...
import type { NavigateConfig } from "../../core/schema/types/focus/config/FocusNavigateConfig.ts";
import type { Direction } from "../../core/schema/types/focus/FocusDirection.ts";
import { resolveEntry } from "./entry.ts";
import { type NavigateResult, resolveWithStrategy } from "./strategies.ts";
