...
export interface CollectionZoneHandle<S> extends ZoneHandle<S> {
    ...
    move: CommandFactory<string, { id: string; toParentId?: string; afterId?: string }>;
...
export function autoDeepClone<T extends { id: string }>(item: T, newId: string, uid: () => string): T {
