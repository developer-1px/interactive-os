...
import {
  ...
  simulateClick,
  simulateKeyPress,
} from "../../core/library/headless";

// Ensure OS defaults are registered
import "@os/2-resolve/osDefaults";
...
export interface OsPage {
  ...
  OS_FOCUS: typeof import("@os/4-command/focus/focus").OS_FOCUS;
  OS_SYNC_FOCUS: typeof import("@os/4-command/focus/syncFocus").OS_SYNC_FOCUS;
  OS_SELECT: typeof import("@os/4-command/selection/select").OS_SELECT;
  OS_NAVIGATE: typeof import("@os/4-command/navigate").OS_NAVIGATE;
  OS_TAB: typeof import("@os/4-command/tab/tab").OS_TAB;
  OS_ESCAPE: typeof import("@os/4-command/dismiss/escape").OS_ESCAPE;
  OS_SELECTION_CLEAR: typeof import("@os/4-command/selection/selection").OS_SELECTION_CLEAR;
  OS_STACK_PUSH: typeof import("@os/4-command/focus/stack").OS_STACK_PUSH;
  OS_STACK_POP: typeof import("@os/4-command/focus/stack").OS_STACK_POP;
  OS_EXPAND: typeof import("@os/4-command/expand/index").OS_EXPAND;
  OS_FIELD_START_EDIT: typeof import("@os/4-command/field/field").OS_FIELD_START_EDIT;
  OS_ACTIVATE: typeof import("@os/4-command/activate/activate").OS_ACTIVATE;
  OS_CHECK: typeof import("@os/4-command").OS_CHECK;
  OS_DELETE: typeof import("@os/4-command/crud/delete").OS_DELETE;
  OS_VALUE_CHANGE: typeof import("@os/4-command/valueChange").OS_VALUE_CHANGE;
}
...
import { OS_CHECK as prodCHECK } from "@os/4-command";
import { OS_ACTIVATE as prodACTIVATE } from "@os/4-command/activate/activate";
import { OS_DELETE as prodDELETE } from "@os/4-command/crud/delete";
import { OS_ESCAPE as prodOS_ESCAPE } from "@os/4-command/dismiss/escape";
import { OS_EXPAND as prodEXPAND } from "@os/4-command/expand/index";
import { OS_FIELD_START_EDIT as prodFIELD_START_EDIT } from "@os/4-command/field/field";
import { OS_FOCUS as prodOS_FOCUS } from "@os/4-command/focus/focus";
import {
  OS_STACK_POP as prodSTACK_POP,
  OS_STACK_PUSH as prodSTACK_PUSH,
} from "@os/4-command/focus/stack";
import { OS_SYNC_FOCUS as prodSYNC_FOCUS } from "@os/4-command/focus/syncFocus";
import { OS_NAVIGATE as prodNAVIGATE } from "@os/4-command/navigate";
import { OS_SELECT as prodOS_SELECT } from "@os/4-command/selection/select";
import { OS_SELECTION_CLEAR as prodSELECTION_CLEAR } from "@os/4-command/selection/selection";
import { OS_TAB as prodOS_TAB } from "@os/4-command/tab/tab";
import { OS_VALUE_CHANGE as prodVALUE_CHANGE } from "@os/4-command/valueChange";
