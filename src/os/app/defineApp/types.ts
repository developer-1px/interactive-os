...
} from "@os/app/defineApp/trigger";
import type React from "react";
import type { ReactNode } from "react";
import type { ZodSchema } from "zod";
import type { FieldMode } from "../../6-project/field/Field";
import type { FieldCommandFactory } from "../../core/schema/types/command/BaseCommand";
...
export interface ZoneBindings {
  ...
  onUndo?: BaseCommand;
  onRedo?: BaseCommand;
  options?: import("@os/6-project/Zone").ZoneOptions;
...
export interface AppPage<S> {
  ...
  locator(elementId: string): import("@os/app/defineApp/page").OsLocator;
