...
import { Keybindings as KeybindingsRegistry } from "@os/2-resolve/keybindings";
import { Field } from "@os/6-project/field/Field";
import { Item } from "@os/6-project/Item";
import type { ZoneOptions } from "@os/6-project/Zone";
import { useZoneContext, Zone } from "@os/6-project/Zone";
...
export function createBoundComponents<S>(
  ...
  const FieldComponent: React.FC<{
    ...
    className?: string;
    autoFocus?: boolean;
    mode?: import("@os/6-project/field/Field").FieldMode;
