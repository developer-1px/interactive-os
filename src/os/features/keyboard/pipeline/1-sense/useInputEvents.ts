...
const onInput = (e: Event) => {
    ...
    logger.debug('KEYBOARD', '[P1:Input] Sync:', { fieldId, textLength: text.length });
...
const INPUT_LISTENERS: EventListenerConfig[] = [
    { target: 'document', event: 'input', handler: onInput, options: { capture: true } },
    { target: 'document', event: 'blur', handler: onBlur, options: { capture: true } },
];
