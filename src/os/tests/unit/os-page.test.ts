...
describe("OsPage: Listbox PoC", () => {
    it("ArrowDown navigates focus", () => {
        ...
        page.goto("listbox", { items: ITEMS, config: SINGLE_SELECT, role: "listbox", focusedItemId: "apple" });
    ...
    it("Home moves to first item", () => {
        const page = createOsPage();
        page.goto("listbox", { items: ITEMS, config: SINGLE_SELECT, role: "listbox", focusedItemId: "cherry" });
    ...
    it("boundary clamp: ArrowDown at last item stays", () => {
        const page = createOsPage();
        page.goto("listbox", { items: ITEMS, config: SINGLE_SELECT, role: "listbox", focusedItemId: "elderberry" });
