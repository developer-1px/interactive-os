...
import { resolveItemKey } from "@os/2-resolve/resolveItemKey";
...
describe("resolveItemKey (Item-layer keybindings)", () => {
  ...
  // ═══════════════════════════════════════
  // checkbox / switch roles — Now handled by Field layer (Layer 1b)
  // resolveItemKey returns null; resolveFieldKeyByType handles Space/Enter
  // ═══════════════════════════════════════
  ...
  describe("switch", () => {
    ...
    it("Enter → null (moved to Field layer: boolean)", () => {
