...
import { OS_ACTIVATE, OS_EXPAND, OS_SELECT } from "@os/4-command";
...
//
// NOTE: checkbox, switch, slider have been moved to the Field layer.
// boolean/number Fields are always-active — their keys are resolved
// via resolveFieldKeyByType in resolveKeyboard Layer 1b.
// ═══════════════════════════════════════════════════════════════════
