import type { ContextState, LogicNode } from "./types";
...
export function compileWhen(expr: LogicNode | string | undefined): LogicNode {
    if (typeof expr === "function") return expr;
    return Object.assign((c: ContextState) => evalContext(expr, c), { toString: () => expr || "TRUE" }) as LogicNode;
}
