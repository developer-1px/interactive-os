...
import {
  type KeyboardInput,
  resolveKeyboard,
} from "@os/1-listen/keyboard/resolveKeyboard";
import { type ClickInput, resolveClick } from "@os/1-listen/mouse/resolveClick";
import { type MouseInput, resolveMouse } from "@os/1-listen/mouse/resolveMouse";
import { ROLE_FIELD_TYPE_MAP } from "@os/2-resolve/resolveFieldKey";
import {
  buildZoneEntry,
  createZoneConfig,
  generateZoneId,
  type ZoneCallbacks,
} from "@os/3-inject/zoneContext";
import { OS_COPY, OS_CUT, OS_PASTE } from "@os/4-command/clipboard/clipboard";
import { OS_ZONE_INIT } from "@os/4-command/focus";
import {
  getChildRole,
  type ZoneRole,
