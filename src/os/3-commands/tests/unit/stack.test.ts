 ...
 *
 * Tests OS_STACK_PUSH / OS_STACK_POP pure state transitions:
...
import { OS_STACK_POP, OS_STACK_PUSH } from "@os/3-commands/focus/stack";
...
describe("Focus Stack (SPEC §8)", () => {
  ...
  describe("OS_STACK_PUSH", () => {
    ...
    it("saves triggeredBy metadata", () => {
      setupFocus("z1", "item-a");
      os.dispatch((OS_STACK_PUSH as any)({ triggeredBy: "modal-open" }));
