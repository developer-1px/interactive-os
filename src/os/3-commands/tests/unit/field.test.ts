...
import { FIELD_CANCEL, FIELD_COMMIT, FIELD_START_EDIT } from "@os/3-commands/field/field";
...
function setupFocus(zoneId: string, focusedItemId: string, extra: Partial<typeof initialZoneState> = {}) {
