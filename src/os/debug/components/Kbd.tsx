...
export const Kbd = memo(
  ({ children, className, variant = "default", size = "sm" }: KbdProps) => {
    const baseStyles =
      "inline-flex items-center justify-center rounded font-mono font-black border select-none transition-all duration-200";
