...
export const InspectorStore = {
  ...
  toggle: () => useInspectorStore.setState((s) => ({ isOpen: !s.isOpen })),

  setOpen: (open: boolean) => useInspectorStore.setState({ isOpen: open }),

  setActiveTab: (tab: string) => useInspectorStore.getState().setActiveTab(tab),
